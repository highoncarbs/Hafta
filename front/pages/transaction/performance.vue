...
<span  class="tag heading has-text-weight-medium is-rounded"
        ...
        <div class="field is-grouped is-grouped-multiline">
            ...
            <template  slot-scope="props">
                ...
                <p class="has-text-grey">{{ titleCase(props.option.company[0].name +', '+props.option.company[0].location[0].name) }}</p>
            </template>
            </b-autocomplete>
            ...
            <div class="control">
                <b-field label="From">
                    <b-datepicker v-model="fromdate" placeholder="From Date"></b-datepicker>
                </b-field>
            ...
            <div class="control">
                <label for="" class="label has-text-grey"> Generate</label>
                    ...
                    <tr class="has-text-weight-semibold ">
                        <th @click="sortBy('from')">From
                            <span class="icon icon-btn icon-btn-in">
                                ...
                                <b-icon v-if="this.currentSort == 'from'"
                                    :type="this.currentSortDir == 'asc' ? 'chevron-up' : 'chevron-down'"></b-icon>
                            </span>
                            </b-icon>
                        </th>
                        ...
                        <th @click=" sortBy('to')">To
                            <span class="icon icon-btn icon-btn-in">
                                ...
                                <b-icon v-if="this.currentSort == 'to'"
                                    :type="this.currentSortDir == 'asc' ? 'chevron-up' : 'chevron-down'"></b-icon>
                            </span>
                        </th>
                        <th @click=" sortBy('name')">Employee
                            <span class="icon icon-btn icon-btn-in">
                                ...
                                <b-icon v-if="this.currentSort == 'name'"
                                    :type="this.currentSortDir == 'asc' ? 'chevron-up' : 'chevron-down'"></b-icon>
                            </span>
                        </th>
                        <th @click=" sortBy('performance')">Performance
                            <span class="icon icon-btn icon-btn-in">
                                ...
                                <b-icon v-if="this.currentSort == 'performance'"
                                    :type="this.currentSortDir == 'asc' ? 'chevron-up' : 'chevron-down'"></b-icon>
                            </span>
                        </th>
                        <th></th>
