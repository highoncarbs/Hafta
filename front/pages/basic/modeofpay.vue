<template>
  <div>
    <div class="has-background-white" style="border-top: 1px solid #eee">
      ...
      >
        <p class="is-size-5 has-text-weight-bold">Mode of Pay</p>
        <br />
        <!-- Edit Modal -->
        <b-modal v-model="modal">
            <div class="card">
              <div class="card-content">
                <div class="content">
                  <p class="has-text-weight-bold is-size-5">Edit Mode of Pay</p>
...
export default {
  ...
  methods: {
    ...
    saveEditData(e) {
      ...
      if (this.edit.name == "") {
        this.edit.errors.push("Mode of Pay required");
      }
