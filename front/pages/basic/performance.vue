<template>
  <div>
    <div class="has-background-white" style="border-top: 1px solid #eee">
      ...
      >
        <p class="is-size-5 has-text-weight-bold">Performance Factor</p>
        <br />
        <!-- Edit Modal -->
        <b-modal v-model="modal">
            <div class="card">
              <div class="card-content">
                <div class="content">
                  <p class="has-text-weight-bold is-size-5">Edit Performance Factor</p>

                  <b-field
                    labe="Performance Factor"
        ...
        >
          <div class="columns">
            <div class="column">
              ...
              <b-field expanded label="Name" :type="{ 'is-danger': form.errors.name }">
                <b-input expanded 
                  v-model="form.name"
                  ref="name"
                ...
                ></b-input>
                        ...
                        <div class="control">
              <b-field label="Max. Score" :type="{ 'is-danger': form.errors.score }">
                <b-input
                ...
                ></b-input>
                        ...
                        <div class="control">
              <b-field label="Weight" :type="{ 'is-danger': form.errors.weight }">
                <b-input
        ...
        <div v-show="!view" class="animated fadeIn">
          ...
          <div class id="data_view">
            ...
            >
              ...
              <b-table-column v-slot="props" label="Max. Score">{{
                props.row.score
              }}</b-table-column>
              <b-table-column v-slot="props" label="Weight">{{
                props.row.weight
              }}</b-table-column>
...
export default {
  ...
  methods: {
    ...
    saveEditData(e) {
      ...
      if (this.edit.name == "") {
        this.edit.errors.push("Performance Factor required");
      }
