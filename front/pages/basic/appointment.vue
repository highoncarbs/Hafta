<template>
  <div>
    <div class="has-background-white" style="border-top: 1px solid #eee">
      ...
      >
        <p class="is-size-5 has-text-weight-bold">Appointment</p>
        <br />
        <!-- Edit Modal -->
        <div
          ...
          <div class="modal-content">
            <div class="card">
              <div class="card-content">
                <div class="content">
                  <p class="has-text-weight-bold is-size-5">Edit Appointment</p>
...
export default {
  ...
  methods: {
    ...
    saveEditData(e) {
      ...
      if (this.edit.name) {
        this.$axios
          .post("/master/edit/appointment", this.edit)
          .then(function (response) {
            if (response.data.success) {
      ...
      if (this.edit.name == "") {
        this.edit.errors.push("Appointment required");
      }
    ...
    deleteData(data, index) {
      ...
      let self = this;
      this.$axios
        .post("/master/delete/appointment", data)
        .then(function (response) {
          if (response.data.success) {
